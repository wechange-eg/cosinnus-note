...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Note.objects.select_for_update().filter(text_markup_type='').update(text_markup_type='plain')
        orm.Comment.objects.select_for_update().filter(text_markup_type='').update(text_markup_type='plain')
