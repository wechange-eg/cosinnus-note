...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.creator'
        db.add_column(u'cosinnus_note_note', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_note_note_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Note.created'
        db.add_column(u'cosinnus_note_note', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.creator'
        db.delete_column(u'cosinnus_note_note', 'creator_id')

        # Deleting field 'Note.created'
        db.delete_column(u'cosinnus_note_note', 'created')
