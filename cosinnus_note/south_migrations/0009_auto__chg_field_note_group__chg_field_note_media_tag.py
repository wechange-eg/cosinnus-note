...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cosinnus_note_note', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'Note.media_tag'
        db.alter_column(u'cosinnus_note_note', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Note.media_tag'
        db.alter_column(u'cosinnus_note_note', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'cosinnus_note.comment': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cosinnus_note.note': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_note_note_set'", 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
